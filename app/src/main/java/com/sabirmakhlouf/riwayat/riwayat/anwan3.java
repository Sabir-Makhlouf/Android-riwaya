...
public class anwan3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anwan3);
    ...
    public void txt5(View view) {
        ...
        Intent intent = new Intent(anwan3.this, txt3_3.class);
    ...
    public void txt4(View view) {        if (mInterstitialAd.isLoaded()) {
        ...
        Intent intent = new Intent(anwan3.this, txt3_5.class);
        startActivity(intent);
    ...
    public void txt3(View view) {        if (mInterstitialAd.isLoaded()) {
        ...
        Intent intent = new Intent(anwan3.this, txt3_4.class);
        startActivity(intent);
    ...
    public void txt2(View view) {        if (mInterstitialAd.isLoaded()) {
        ...
        Intent intent = new Intent(anwan3.this, txt3_2.class);
        startActivity(intent);
    ...
    public void txt1(View view) {        if (mInterstitialAd.isLoaded()) {
        ...
        Intent intent = new Intent(anwan3.this, txt3_1.class);
        startActivity(intent);
